...
5. Destaque de Go e concorrência — 2 minutos
   ...
   - Mostrar o documento em [docs/tecnico/paralelismo_go.md](../tecnico/paralelismo_go.md) como roteiro técnico
...
- Use o documento [docs/tecnico/paralelismo_go.md](../tecnico/paralelismo_go.md) como guia de roteiro
